        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-extrabold">Gym<span className="text-teal-400">Desk</span></span>
            </Link>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@gymdesk.in" className="hover:text-teal-400 transition-colors">info@gymdesk.in</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 text-teal-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+918587885643" className="hover:text-teal-400 transition-colors">+91 85878 85643</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={link.to}>
                  <Link to={link.to} className="text-gray-400 hover:text-teal-400 text-sm transition-colors">{link.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={link.label}>
                  <a href={link.href} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-teal-400 text-sm transition-colors">{link.label}</a>
                </li>
              ))}
            </ul>
          </div>
